...
from dl.classifiers.lstm.lstm import EmailRNN
...
if __name__ == '__main__':
    ...
    for train_indices, val_indices, test_indices in dataset_handler.get_indices(under_sample=True):
        ...
        model = EmailRNN(vocab_length, embedding_matrix, lstm_size=lstm_size, hidden_size=hidden_size,
                         num_hidden_layers=num_hidden_layers).get_model()
